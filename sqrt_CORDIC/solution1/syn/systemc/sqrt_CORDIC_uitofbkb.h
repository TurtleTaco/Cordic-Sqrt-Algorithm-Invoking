...
#ifndef __sqrt_CORDIC_uitofbkb__HH__
#define __sqrt_CORDIC_uitofbkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(sqrt_CORDIC_uitofbkb) {
    ...
    SC_CTOR(sqrt_CORDIC_uitofbkb):  ACMP_uitofp_U ("ACMP_uitofp_U") {
